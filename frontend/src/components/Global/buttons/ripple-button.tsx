...
export default function RippleButton({
  ...
  return (
    <button
      ref={buttonRef}
      className="font-jost duration-[600ms] relative flex items-center justify-center overflow-hidden rounded-full bg-[#cbfe7e] px-8 py-2 text-[1.2rem] font-sm text-[#0e352e] transition hover:text-white"
      onMouseEnter={(e) => {
